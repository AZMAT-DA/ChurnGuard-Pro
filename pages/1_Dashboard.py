...
try:
    ...
    data_loaded = False
    st.error("Could not load dataset. Make sure WA_Fn-UseC_-Telco-Customer-Churn.csv is in your project folder.")
    st.stop()
...
with col3:
    ...
    stayed_tenure   = df_raw[df_raw['Churn'] == 'No']['tenure']
    ax.hist(stayed_tenure,  bins=20, alpha=0.6, color='#639922', label='Stayed')
    ax.hist(churned_tenure, bins=20, alpha=0.6, color='#E24B4A', label='Churned')
